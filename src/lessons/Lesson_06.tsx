...
function Lesson_06() {
  ...
  // Если мы явно не прописываем тип дапнных для переменной при ее создании, 
  // то тип назвначается автоматически, в зависимости от,того 
  // что за тип данных первым попал в переменную
  console.log(hello);
  ...
  //   userArray.push("qwe"); //ругаться программа не будет но так делать не нужжно
  //   userArray.unshift(30);  //так как методы жестко не прописаны
  ///////////////////////////////////////////////////////////////////////
  // 6. functions
  ...
  // 2 cпособ типизации (типизируем саму переменную, а после знака равно идет сама функция)
  ...
  /////////////////////////////////////////////////////////////////////
  // 10 - type (не наследуемые и не дописываемые, но с их помощью можно создавать свой тип данных)
  ...
  type UserDataFromServerType = User | null | undefined; //это можно потом переиспользовать
